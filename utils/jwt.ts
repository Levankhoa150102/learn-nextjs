...
export function signAccessToken(payload: object, expiresIn: SignOptions['expiresIn'] = '15m'): string {
  return jwt.sign(payload, ACCESS_TOKEN_SECRET as string, { expiresIn });
}

export function signRefreshToken(payload: object, expiresIn: SignOptions['expiresIn'] = '7d'): string {
